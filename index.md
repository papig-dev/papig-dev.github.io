...
<div class="app-grid">
  ...
  <div class="app-card">
    <a class="app-card-link" href="/blog/expensecal/">
      <div class="app-icon"><img src="/assets/images/expensecal-icon.jpg" alt="지출달력 앱 아이콘"></div>
      <h3 class="app-name">지출달력</h3>
      <p class="app-desc">이번 달 나갈 지출을 달력에 미리 올려두고, 예정대로 잘 나갔는지 한눈에 확인하는 월간 지출 관리</p>
    </a>
    <div class="app-actions">
  ...
  <div class="app-card">
    <a class="app-card-link" href="/blog/keepstreak/">
  ...
  <div class="app-card">
    <a class="app-card-link" href="/blog/chagoklog/">
